...
<img src="img/img_1.png" width="300"/>고객의 이탈 여부(`Churn`)에 따라 만족도 점수(`SatisfactionScore`)의 차이가 있는지를 확인하기 위해 시각화 및 독립표본 t-검정을 수행함.
...
<img src="img/img_2.png" width="300"/>고객의 최근 주문까지의 일수(`DaySinceLastOrder`)가 이탈 여부(`Churn`)에 영향을 미치는지를 확인하기 위해  
